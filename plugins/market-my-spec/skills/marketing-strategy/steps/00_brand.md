...
- Existing visual identity from other tools (Claude Design output, Figma files, Dribbble shots, hired-designer deliverables)

**If visual identity work has already been done elsewhere (Claude Design, Figma, hired designer), pull those assets and don't redo them. Capture them in this artifact and reference the source.** The job here is consolidation, not regeneration.
...
**If visual identity already exists** (Claude Design output, Figma file, hired designer deliverables): capture the existing color hex codes, font names, logo files, and design rules into the artifact. Reference the source ("colors from Claude Design session 2026-04-15"). Skip generation.
...
- Provide a generation prompt for Claude Design / Midjourney / Figma AI
...
- For actual visual generation, use whatever image-generation tool is available in the session (e.g., nanobanana / Midjourney / Claude Design subagent / `seo-image-gen` skill).
...
### Source
[Generated this session / Claude Design [date] / Figma [link] / Hired designer [name+date]]
