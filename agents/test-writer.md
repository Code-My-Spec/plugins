...
tools: Read, Write, Glob, Grep, Bash, Bash(mix test *), Bash(mix spex *), mcp__plugin_codemyspec_codemyspec__start_task, mcp__plugin_codemyspec_codemyspec__evaluate_task, mcp__plugin_codemyspec_*
